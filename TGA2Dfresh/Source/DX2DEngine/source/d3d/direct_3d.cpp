...
bool CDirectEngine::Init(const CEngine& aEngine, Vector2<unsigned int> aWindowSize, SEngineCreateParameters& someParameters)
{
...
void Tga2D::CDirectEngine::SetResolution(Tga2D::Vector2<unsigned int> aResolution)
{
	...
	if (mySwapchain->ResizeBuffers(0, myWindowSize.x, myWindowSize.y, DXGI_FORMAT_UNKNOWN, 0) != S_OK)
	{
