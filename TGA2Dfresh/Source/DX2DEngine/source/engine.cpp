...
void Tga2D::CEngine::UpdateWindowSizeChanges(bool aIgnoreAutoUpdate)
{
	...
	{
		SetResolution(Tga2D::Vector2<unsigned int>(myCreateParameters.myTargetWidth, myCreateParameters.myTargetHeight), false);
...
void Tga2D::CEngine::SetResolution(const Tga2D::Vector2ui &aResolution, bool aAlsoSetWindowSize)
{
